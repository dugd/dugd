...
|--------|-----------|------|
| [GiftApp](https://github.com/dugd/GiftApp2) | RESTfull web server for mobile application | Python, FastAPI, SQLAlchemy |
| [USign](https://github.com/dugd/U-Sign-Laravel) | Monolithic web-application of gestures | Laravel, Docker, Tailwind |
| [NameGena-bot](https://github.com/dugd/namegena-bot) | Telegram bot names generator | TypeScript, Express, TelegramBotAPI |
